...
[![Build Status](https://github.com/montovaneli/gin-swagger/actions/workflows/ci.yml/badge.svg?branch=master)](https://github.com/features/actions)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/montovaneli/gin-swagger)](https://goreportcard.com/report/github.com/montovaneli/gin-swagger)
[![GoDoc](https://godoc.org/github.com/montovaneli/gin-swagger?status.svg)](https://godoc.org/github.com/montovaneli/gin-swagger)
[![Release](https://img.shields.io/github/release/swaggo/gin-swagger.svg?style=flat-square)](https://github.com/montovaneli/gin-swagger/releases)
...
4. Download [gin-swagger](https://github.com/montovaneli/gin-swagger) by using:

```sh
go get -u github.com/montovaneli/gin-swagger
...
```go
import "github.com/montovaneli/gin-swagger" // gin-swagger middleware
...
import (
   ...
   ginSwagger "github.com/montovaneli/gin-swagger"
   "net/http"
)
// @BasePath /api/v1
